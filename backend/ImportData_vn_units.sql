...
/* Reference: https://github.com/ThangLeQuoc/vietnamese-provincelist-database */
/* =============================================== */

-- DATA for administrativeregionlist --
INSERT INTO administrativeregionlist(id,name_vi,name_en,code_name,code_name_en) VALUES(1,'Đông Bắc Bộ','Northeast','dong_bac_bo','northest');
INSERT INTO administrativeregionlist(id,name_vi,name_en,code_name,code_name_en) VALUES(2,'Tây Bắc Bộ','Northwest','tay_bac_bo','northwest');
INSERT INTO administrativeregionlist(id,name_vi,name_en,code_name,code_name_en) VALUES(3,'Đồng bằng sông Hồng','Red River Delta','dong_bang_song_hong','red_river_delta');
INSERT INTO administrativeregionlist(id,name_vi,name_en,code_name,code_name_en) VALUES(4,'Bắc Trung Bộ','North Central Coast','bac_trung_bo','north_central_coast');
INSERT INTO administrativeregionlist(id,name_vi,name_en,code_name,code_name_en) VALUES(5,'Duyên hải Nam Trung Bộ','South Central Coast','duyen_hai_nam_trung_bo','south_central_coast');
INSERT INTO administrativeregionlist(id,name_vi,name_en,code_name,code_name_en) VALUES(6,'Tây Nguyên','Central Highlands','tay_nguyen','central_highlands');
INSERT INTO administrativeregionlist(id,name_vi,name_en,code_name,code_name_en) VALUES(7,'Đông Nam Bộ','Southeast','dong_nam_bo','southeast');
INSERT INTO administrativeregionlist(id,name_vi,name_en,code_name,code_name_en) VALUES(8,'Đồng bằng sông Cửu Long','Mekong River Delta','dong_bang_song_cuu_long','southwest');
------------------------------------

-- DATA for administrativeunitlist --
INSERT INTO administrativeunitlist(id,full_name_vi,full_name_en,short_name_vi,short_name_en,code_name,code_name_en) VALUES(1,'Thành phố trực thuộc trung ương','Municipality','Thành phố','City','thanh_pho_truc_thuoc_trung_uong','municipality');
INSERT INTO administrativeunitlist(id,full_name_vi,full_name_en,short_name_vi,short_name_en,code_name,code_name_en) VALUES(2,'Tỉnh','Province','Tỉnh','Province','tinh','province');
INSERT INTO administrativeunitlist(id,full_name_vi,full_name_en,short_name_vi,short_name_en,code_name,code_name_en) VALUES(3,'Phường','Ward','Phường','Ward','phuong','ward');
INSERT INTO administrativeunitlist(id,full_name_vi,full_name_en,short_name_vi,short_name_en,code_name,code_name_en) VALUES(4,'Xã','Commune','Xã','Commune','xa','commune');
INSERT INTO administrativeunitlist(id,full_name_vi,full_name_en,short_name_vi,short_name_en,code_name,code_name_en) VALUES(5,'Đặc khu tại hải đảo','Special administrative region','Đặc khu','Special administrative region','dac_khu','special_administrative_region');
------------------------------------

-- DATA for provincelist --
INSERT INTO provincelist(code,name_vi,name_en,full_name_vi,full_name_en,code_name,administrative_unit_id) VALUES
...
-- DATA for wardlist --
INSERT INTO wardlist(code,name_vi,name_en,full_name_vi,full_name_en,code_name,province_code,administrative_unit_id) VALUES
